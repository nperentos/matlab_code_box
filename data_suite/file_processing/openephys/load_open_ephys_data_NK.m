...
% Nikolas Karalis : edit
MAX_NUMBER_OF_RECORDS = round(filesize/2048);
MAX_NUMBER_OF_CONTINUOUS_SAMPLES = round(filesize/2048)*1024;
...
elseif strcmp(filetype, 'continuous')
    ...
    data = zeros(MAX_NUMBER_OF_CONTINUOUS_SAMPLES, 1,'int16');
