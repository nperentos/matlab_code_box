%function Kluster(FileBase,Data,Program, SampleRate, NormFet)
% create clustering stuff
%Data = {Fet,Spk,Res,Clu}
% Spk has to be [nChannels, SpkSampls, nSpikes]);
% Fet has to be [nSpikes, nFet, nChannels]
% and start the manual clustering program
% {'sgclustb', 'klusters','xgobi'}
function Kluster(FileBase,Data,varargin)

[Program, SampleRate,NormFet] = DefaultArgs(varargin,{[], 20000,1});
tmpfn = 0;
if isempty(FileBase)
