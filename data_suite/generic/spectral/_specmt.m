...
%% Arguments
options = {'defaults',[],'window',1,'overlap',90,'pad',1,'nw',3, 'whiten', 0,'freqrange',...
    [],'pointprocess',0,'sr',1000,'spikeSR', 1000, 'tapers',[], 'minspikes',[],'detrend','linear','blocksize',2^16};
...
% Allocate memory
Sxy=complex(zeros(nFFTChunks,nFreqBins, nChannels, nChannels)); % output array memory allocation
