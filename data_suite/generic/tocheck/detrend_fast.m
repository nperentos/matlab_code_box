% This is exactly the same with the detrend.m of Matlab, except it uses the
% unique_fast instead of unique.
%
% Author : Nikolas Karalis
% Date : 03/12/2013
function y = detrend_fast(x,o,bp)
...
%   $Revision: 1.9.4.5 $  $Date: 2012/10/15 20:09:07 $
...
switch o
    ...
    case {1,'l','linear'}
        N = size(x,1);
        bp = unique_fast([1; double(bp(:)); N]);   % Include both endpoints
