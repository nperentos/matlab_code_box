% Description : A local copy of the findpeaks algorithm in Matlab's Digital
% Signal Processign toolbox.
%
% Algorithm : It is copied here to be used and avoid conflicts with other
...
function [pks,locs] = findpeaks_DSP(X,varargin)
