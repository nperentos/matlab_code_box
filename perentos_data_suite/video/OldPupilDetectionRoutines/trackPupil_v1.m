function trackPupil_v1(fldrName,init,track, frams, downSampleFlag, verb)
% this version of track pupil we are loading single frames and processing
% as we go. This avoids memory issues that are encountered when trying to
% load large video files in memory.
...
test = (dir(fullfile(fullPath,'pupil*.avi')));
if ~size(test,1)
